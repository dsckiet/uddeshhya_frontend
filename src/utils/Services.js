...
export const contact = (data, headers) =>
  axios.post(contactAPI, data, headers).then(res => res);
export const messages = headers =>
  axios.get(messagesAPI, headers).then(res => res.data);
